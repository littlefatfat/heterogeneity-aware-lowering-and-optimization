...
class CXXCodeGenOpts(Structure):
    _fields_ = [
        ...
        ("simplify_for_preprocess", c_bool),    # add
        ...
        ("template_file", c_char_p),  # add
        ("save_temps", c_bool),
        ("constant_decombine", c_bool),  # add
        ("convert_split_to_slice", c_bool),  # add
